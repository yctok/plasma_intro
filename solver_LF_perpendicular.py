# -*- coding: utf-8 -*-
"""
Created on Mon Apr  8 10:45:49 2024
...
omega_LH = np.sqrt(omega_ce * omega_ci * (omega_ci ** 2 + omega_pi ** 2)/(omega_pi **2 + omega_ci * omega_ce))
...
inputs_1 = {
    ...
    "B": B0 * u.T,
    "w": np.linspace(omega_pe*1e-6, omega_pe*0.1, 5000)  * u.rad / u.s,
}
...
plt.xlim(0.01, 3.0)  
plt.ylim(0.0, omega_LH/omega_pe)
